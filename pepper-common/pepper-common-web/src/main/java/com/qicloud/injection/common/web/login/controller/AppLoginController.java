 ...
 */
@Controller
@RequestMapping(value = "/app/user/account", method = { RequestMethod.POST })
public class AppLoginController extends BaseLoginImpl implements BaseController {
	...
	public Object login(String account, String pwd)
		...
		login(memberId, resourceList, appAuthorize);
	...
	public Object loginOut() {
		String token = this.getCookie(appAuthorize.getAuthorizeCookieName());
		logout(token, appAuthorize);
		return new ResultData();
	}
