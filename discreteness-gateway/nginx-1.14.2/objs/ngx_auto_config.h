#define NGX_CONFIGURE " --prefix=/usr/local/nginx --with-ld-opt=-Wl,-rpath,/usr/local/lib --with-http_image_filter_module --with-http_stub_status_module --with-http_ssl_module --with-http_realip_module --add-module=../redis2-nginx-module-master --add-module=../ngx_devel_kit-master --add-module=../set-misc-nginx-module-master --add-module=../ngx_http_redis-0.3.8 --add-module=../lua-nginx-module-master --add-module=../echo-nginx-module-master --add-module=../ngx_zookeeper_lua --with-debug"
