#define NGX_CONFIGURE " --prefix=/development/project/hamster/pepper-discreteness/discreteness-gateway/ngx_zookeeper_lua/install/nginx-1.13.6 --with-cc-opt='-I/development/project/hamster/pepper-discreteness/discreteness-gateway/ngx_zookeeper_lua/build/deps/pcre/include -I/development/project/hamster/pepper-discreteness/discreteness-gateway/ngx_zookeeper_lua/build/deps/zlib/include' --with-ld-opt='-L/development/project/hamster/pepper-discreteness/discreteness-gateway/ngx_zookeeper_lua/build/deps/pcre/lib -L/development/project/hamster/pepper-discreteness/discreteness-gateway/ngx_zookeeper_lua/build/deps/zlib/lib' --add-module=../ngx_devel_kit --add-module=../lua-nginx-module --add-module=../.."
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/development/project/hamster/pepper-discreteness/discreteness-gateway/ngx_zookeeper_lua/install/nginx-1.13.6/"
#endif
